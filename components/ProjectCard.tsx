...
const ProjectCard: FunctionComponent<{
    ...
    return (
        <div>
            ...
            {showDetail === id && (
                <div
                    className="rounded-lg md: p-10 absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-black bg-gray-100 md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100">
                    <motion.div
                        variants={stagger}
                        initial='initial'
                        animate='animate'
